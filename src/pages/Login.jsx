...
import { Card, TextField, Button, Text, Flex, Heading, Callout } from '@radix-ui/themes';
              ...
              <Card className="w-full max-w-md !bg-transparent !shadow-none">
                  <Flex direction="column" gap="4">
                      <div className="text-center text-white h-20 flex items-center justify-center">
                        <Heading as="h1" size="9" className="font-italianno">
                            {animatedText}
                            <span className="inline-block w-1 h-16 bg-white ml-2 animate-blink"></span>
                        </Heading>
                      </div>
                      ...
                      <div className="text-center text-white/80">
                          <Text as="p" size="2">
                              Don't have an account? <Link to="/register" className="font-bold text-cyan-400 hover:underline">Sign up</Link>
                          </Text>
                      </div>
                  </Flex>
              </Card>
